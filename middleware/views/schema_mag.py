        ...
        try:
            ...
            if status_code == 200:
                ...
                if role_found:
                    ...
                    logger.info('User has guest role. He does not have access to MAG database.. '
                            'Please login with BTAA member institution, if you are part of it..')
                    raise Exception('User is not authorized to access data in MAG !')
